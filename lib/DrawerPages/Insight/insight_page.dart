...
class _InsightPageState extends State<InsightPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(getString(Strings.INSIGHT)!),
      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                  getString(Strings.TODAY)!.toUpperCase(),
                                    ...
                                    text: TextSpan(children: <TextSpan>[
                                      TextSpan(
                                          ...
                                          style: Theme.of(context)
                                              ...
                                              .copyWith(fontSize: 17)),
                                      TextSpan(
                                          text: getString(Strings.EARNINGS),
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyText1!
                                              .copyWith(
                            ...
                            Text(
                              getString(Strings.EARNINGS)!.toUpperCase(),
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyText1!
                            ...
                            Center(
                              child: Text(
                                getString(Strings.VIEW_ALL_TRANSACTIONS)!,
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText2!
                                    .copyWith(
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              getString(Strings.CURRENT_RATINGS)!,
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyText1!
                                  .copyWith(fontSize: 15, letterSpacing: 0.7),
                            ...
                            Center(
                              child: Text(
                                getString(Strings.READ_ALL_REVIEWS)!,
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText2!
                                    .copyWith(
