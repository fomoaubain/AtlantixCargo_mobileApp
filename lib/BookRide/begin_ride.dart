                    ...
                    SafeArea(
                      ...
                      child: Row(
                        children: [
                          Text(
                              !beginRide
                                  ? getString(Strings.BEGIN_RIDE)!
                                  : getString(Strings.YOUR_TRIP)!,
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        buildFlatButton(
                            Icons.call, getString(Strings.CALL_NOW)!),
                        SizedBox(width: 8),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Spacer(),
                  buildRowItem(theme, getString(Strings.RIDE_FARE)!, '\$ 40.50',
                      Icons.account_balance_wallet),
                  Spacer(),
                  buildRowItem(theme, context.getString(Strings.RIDE_TYPE)!,
                      context.getString(Strings.GO_PRIVATE)!, Icons.drive_eta),
                ],
              ),
            ),
            SizedBox(height: 60,),
